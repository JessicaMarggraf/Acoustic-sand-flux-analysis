...
# Load TW16 results
# phi_TW16 = pd.read_csv(r'C:\Users\jessi\OneDrive\Dokumente\Acoustics\10_TW16\Phi_sand_kg_s.csv', sep = ';')
# Time_datetime_TW16 = phi_TW16['Date']
# Time_datetime_TW16 = list(Time_datetime_TW16)
# Time_datetime_TW16 = pd.to_datetime(Time_datetime_TW16)    
# Time_datetime_TW16_int = [int(Time_datetime_TW16[i].timestamp()) for i in range(len(Time_datetime_TW16))]
# phi_TW16_cumsum = np.array(phi_TW16['Phi_sand_S2_D50_kg_s_cumsum'])
# phi_TW16_kg_s = np.array(phi_TW16['Phi_sand_S2_D50_kg_s'])   
# total_phi_TW16_t = phi_TW16_cumsum[-2]/1000
# Csand_TW16 = pd.read_csv(r'C:\Users\jessi\OneDrive\Dokumente\Acoustics\10_TW16\C_sand_g_l.csv', sep = ';')

# # Load TW16_B results
# phi_TW16_B = pd.read_csv(r'C:\Users\jessi\OneDrive\Dokumente\Acoustics\12_TW16B\Phi_sand_kg_s.csv', sep = ';')
# Time_datetime_TW16_B = phi_TW16_B['Date']
# Time_datetime_TW16_B = list(Time_datetime_TW16_B)
# Time_datetime_TW16_B = pd.to_datetime(Time_datetime_TW16_B)    
# Time_datetime_TW16_B_int = [int(Time_datetime_TW16_B[i].timestamp()) for i in range(len(Time_datetime_TW16_B))]
# phi_TW16_B_cumsum = np.array(phi_TW16_B['Phi_sand_S2_D50_kg_s_cumsum'])
# phi_TW16_B_kg_s = np.array(phi_TW16_B['Phi_sand_S2_D50_kg_s'])   
# total_phi_TW16_B_t = phi_TW16_B_cumsum[-2]/1000
# Csand_TW16_B = pd.read_csv(r'C:\Users\jessi\OneDrive\Dokumente\Acoustics\12_TW16B\C_sand_g_l.csv', sep = ';')
...
# ax[0].text(0.05, 0.95, '400 kHz', fontsize = 16, transform = ax[0].transAxes, weight = 'bold')
ax[0].text(0.05, 0.95, '(c)', fontsize = 16, transform = ax[0].transAxes)
...
ax[1].text(0.05, 0.95, '(d)', fontsize = 16, transform = ax[1].transAxes)
# ax[1].text(0.05, 0.95, '1 MHz', fontsize = 16, transform = ax[1].transAxes, weight = 'bold')
# ax[1].text(0.35, 0.95, ('y = ' + str(np.round(slope_alphaSed2_Cfines_TAAPS_ISCO[0],2)) + 'x'),
#     color = 'black', fontsize = 16, transform = ax[1].transAxes)
# ax[1].text(0.35, 0.89, ('R² = ' + str(float(np.round(R2_alphaSed2_Cfines_TAAPS_ISCO,2))) + ', n = ' + str(len(Cfines_TAAPS_ISCO))),
...
fig.tight_layout()
figname = 'AlphaSed_Cfines_theo_TW16A'
...
# ax[0].set_ylabel(r'$\mathregular{\zeta \; \left(\frac{dB \; L}{m \; mg}\right)}$', fontsize=18, weight = 'bold')
...
fig.tight_layout()
figname = 'Fig4_alphaunit'
fig.savefig(outpath_figures +'\\' +  figname + '.png', dpi = 300, bbox_inches='tight')
# fig.savefig(outpath_figures +'\\' +  figname + '.eps',format = 'eps', dpi = 400, bbox_inches='tight')

#%% STEP 11: Fig4 Plot D50- AlphaUnit and log(S) - B' theoretical - empirical 
D50_sand_range_mum = np.arange(63,500,5)
Alphaunit_freq1_fines_range = [zeta_freq1_fines_range[i]*20/np.log(10)/1000 for i in range(len(zeta_freq1_fines_range))]
Alphaunit_freq2_fines_range = [zeta_freq2_fines_range[i]*20/np.log(10)/1000 for i in range(len(zeta_freq2_fines_range))]
Alphaunit_freq1_sand_range = [zeta_freq1_sand_range[i]*20/np.log(10)/1000 for i in range(len(zeta_freq1_sand_range))]
...
# Freq1
ax[0,0].plot(ISCO_data['AlphaSed_freq1'], ISCO_data['Fine_concentration_g_l'],
    'o', color = 'yellowgreen', markersize = 6, markeredgecolor = 'black', markeredgewidth = 0.1,
    zorder = 10, label = r'ISCO')
m1, = ax[0,0].plot(TAAPS_freq2['Alpha Sediment (dB/m)'][0], TAAPS_freq2['Fine_concentration_g_l'][0],
    'D', color = 'darkorange', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.1,
    zorder = 30, label = 'Sampler')
ax[0,0].plot(TAAPS_freq1['Alpha Sediment (dB/m)'], TAAPS_freq1['Fine_concentration_g_l'],
    'D', color = 'darkorange', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.1,
    zorder = 30, label = r'$\mathregular{\overline{C_{fines}}}$')
m2, = ax[0,0].plot(ISCO_data['AlphaSed_freq2'][0], ISCO_data['Fine_concentration_g_l'][0],
    'o', color = 'yellowgreen', markersize = 6, markeredgecolor = 'black', markeredgewidth = 0.1,
    zorder = 10, label = r'$\mathregular{C_{fines, ISCO}}$')
ax[0,0].plot(x_range, lin_model_alphaSed1_Cfines_TAAPS_ISCO_plot, color = 'black', ls = '-')

ax[0,0].text(0.05, 0.95, '(a)', fontsize = 16, transform = ax[0,0].transAxes)

ax[0,0].text(0.35, 0.95, ('y = ' + str(np.round(slope_alphaSed1_Cfines_TAAPS_ISCO[0],2)) + 'x'),
    color = 'black', fontsize = 16, transform = ax[0,0].transAxes)
ax[0,0].text(0.35, 0.89, ('R² = ' + str(float(np.round(R2_alphaSed1_Cfines_TAAPS_ISCO,2))) + ', n = ' + str(len(Cfines_TAAPS_ISCO))),
    color = 'black', fontsize = 16, transform = ax[0,0].transAxes)

ax[0,0].set_ylabel('$\mathregular{\overline{C_{fines}}}$ (g/l)', fontsize=18, weight = 'bold')
ax[0,0].set_xlabel(r'$\mathregular{\alpha_{sed, 400 kHz}}$ (dB/m)', fontsize=18, weight = 'bold')
...
ax[0,1].plot(TAAPS_freq2['Alpha Sediment (dB/m)'], TAAPS_freq2['Fine_concentration_g_l'],
    'D', color = 'darkorange', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.1,
    zorder = 30, label = 'Sampler')
ax[0,1].plot(ISCO_data['AlphaSed_freq2'], ISCO_data['Fine_concentration_g_l'],
    'o', color = 'yellowgreen', markersize = 6, markeredgecolor = 'black', markeredgewidth = 0.1,
    zorder = 10, label = r'ISCO')
# m3, = ax[0,1].plot(ISCO_data['AlphaSed_freq2'][0], ISCO_data['Fine_concentration_g_l'][0],
#     'o', color = 'yellowgreen', markersize = 10, markeredgecolor = 'black', markeredgewidth = 0.1,
#     zorder = 10)

ax[0,1].text(0.35, 0.95, ('y = ' + str(np.round(slope_alphaSed2_Cfines_TAAPS_ISCO[0],2)) + 'x'),
    color = 'black', fontsize = 16, transform = ax[0,1].transAxes)
ax[0,1].text(0.35, 0.89, ('R² = ' + str(float(np.round(R2_alphaSed2_Cfines_TAAPS_ISCO,2))) + ', n = ' + str(len(Cfines_TAAPS_ISCO))),
    color = 'black', fontsize = 16, transform = ax[0,1].transAxes)

ax[0,1].set_ylabel('$\mathregular{\overline{C_{fines}}}$ (g/l)', fontsize=18, weight = 'bold')
ax[0,1].set_xlabel(r'$\mathregular{\alpha_{sed, 1 MHz}}$ (dB/m)', fontsize=18, weight = 'bold')
ax[0,1].text(0.05, 0.95, '(b)', fontsize = 16, transform = ax[0,1].transAxes)
ax[0,1].plot(x_range, lin_model_alphaSed2_Cfines_TAAPS_ISCO_plot, color = 'black', ls = '-')
ax[0,1].tick_params(axis='both', which='major', labelsize = 16)
ax[0,1].set_xlim (0, 4)
ax[0,1].set_ylim(0,5)
ax[0,1].legend(loc = 'lower right', fontsize = 14, framealpha = 1)

# Plot 1
ax[1,0].plot(TAAPS_freq1['D50_mum_fines'], TAAPS_freq1['zeta_fines']*20/np.log(10)/1000, 
        'D', color = 'olive', markersize = 8, markeredgecolor = 'black',markeredgewidth = 0.3,  
        label = '400 kHz', zorder = 30)
ax[1,0].plot(TAAPS_freq1['D50_mum_fines'], TAAPS_freq2['zeta_fines']*20/np.log(10)/1000, 
        's', color = 'mediumorchid', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.3,
        label = '1 MHz', zorder = 30)
ax[1,0].plot(TAAPS_freq1['D50_mum'], TAAPS_freq1['zeta_sand']*20/np.log(10)/1000, 
        'D', color = 'olive', markersize = 8, markeredgecolor = 'black',markeredgewidth = 0.3, zorder = 30, label = 'calculated')
ax[1,0].plot(TAAPS_freq1['D50_mum'], TAAPS_freq2['zeta_sand']*20/np.log(10)/1000, 
        's', color = 'mediumorchid', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.3,zorder = 30, label = 'modeled')

ax[1,0].plot(D50_fines_range_mum, Alphaunit_freq1_fines_range, 
        color = 'olive')
ax[1,0].plot(D50_fines_range_mum, Alphaunit_freq2_fines_range, 
        color = 'mediumorchid')
ax[1,0].plot(D50_sand_range_mum, Alphaunit_freq1_sand_range, 
        color = 'olive')
ax[1,0].plot(D50_sand_range_mum, Alphaunit_freq2_sand_range, 
        color = 'mediumorchid')

ax[1,0].text(0.05, 0.95, '(c)', fontsize = 16, transform = ax[1,0].transAxes)
ax[1,0].grid(linewidth = 0.2)
ax[1,0].grid(which = 'minor', axis = 'x', linewidth = 0.1)
ax[1,0].set_xscale('log')
ax[1,0].set_xlim(5, 500)
ax[1,0].set_ylim(-0.0001, 0.003)
ax[1,0].set_ylabel(r'$\mathregular{\alpha_{unit} \; \left(\frac{dB \; L}{m \; mg}\right)}$', fontsize=18, weight = 'bold')
# ax[1,0].set_ylabel(r'$\mathregular{\zeta \; \left(\frac{dB \; L}{m \; mg}\right)}$', fontsize=18, weight = 'bold')
ax[1,0].set_xlabel(r'$\mathregular{D_{50}}$ ($\mathregular{\mu}$m)', fontsize=18, weight = 'bold')
ax[1,0].tick_params(axis='both', which='major', labelsize = 16)
ax[1,0].vlines(63,-1,1, ls = '--', lw = 1, color = 'black')
ax[1,0].text(0.5, 0.6, 'silt-sand break', fontsize = 14, transform = ax[1,0].transAxes, rotation = 90)

# Plot 2
m3, = ax[1,1].semilogx(sRatio, ExcessBackScat_freq1, ls = '-', lw = 1, color = 'olive', label = 'Model 400 kHz')
           
m4, = ax[1,1].semilogx(sRatio, ExcessBackScat_freq2, ls = '-', lw = 1, color = 'mediumorchid', label = 'Model 1 MHz')

# sc = ax[1,1].semilogx(TAAPS_freq1_fines_GSD['S'], ExcessBackScat_samples_freq1,
#             'D', color = 'olive', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.3, label = 'calculated 400 kHz')
# ax[1,1].semilogx(TAAPS_freq2_fines_GSD['S'], ExcessBackScat_samples_freq2,'s', color = 'mediumorchid',
#                 markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.3, label = 'calculated 1 MHz')


sc, = ax[1,1].semilogx(TAAPS_freq1['S'], ExcessBackScat_samples_freq11,
            'D', color = 'olive', markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.3, label = 'calculated 400 kHz')
m5, = ax[1,1].semilogx(TAAPS_freq2['S'], ExcessBackScat_samples_freq21,'s', color = 'mediumorchid',
                markersize = 8, markeredgecolor = 'black', markeredgewidth = 0.3, label = 'calculated 1 MHz')

ax[1,1].text(0.05, 0.95, '(d)', fontsize = 16, transform = ax[1,1].transAxes)
ax[1,1].grid(linewidth = 0.2)
ax[1,1].grid(which = 'minor', axis = 'x', linewidth = 0.1)
#ax.legend(fontsize = 14)
ax[1,1].set_ylabel(r'$\mathregular{B\' (dB)}$', fontsize=18, weight = 'bold')
ax[1,1].set_xlabel(r'S', fontsize=18, weight = 'bold')
...
ax[1,1].legend(loc = 'upper right', fontsize = 14, framealpha = 1)
# handles = [m1, m2, m3, m4, sc, m5]
# # _, labels = ax[1,0].get_legend_handles_labels()
# fig.legend(handles = handles, #labels=labels, 
#           handler_map = {tuple: mpl.legend_handler.HandlerTuple(None)},
#           loc="center right", framealpha = 1,bbox_to_anchor=(0.97, 0.95), 
#           fontsize = 16)
...
C_fines_samples_g_l = [np.nanmean(C_fines_est_time_freq2[ind_first_beam_av_freq2[i]:ind_last_beam_av_freq2[i]+1])
                     for i in range(len(ind_first_beam_av_freq2))]
C_fines_samples_g_l = C_fines_samples_g_l[0:19] #19 TW16-A and 20 for TW16
...
# 1 
m3, = ax[0].plot(D50_sand_range_mum,RUTS_theo_freq1, 
         ls = '-', lw = 2, color = 'olive', label = 'Model 400 kHz')
m5 = ax[0].vlines(1/k_freq1/1e-6*2, -15,15, color = 'olive',ls = '--', lw = 2)
m6 = ax[0].vlines(1/k_freq2/1e-6*2, -15,15, color = 'mediumorchid',ls = ':', lw = 2)
m4, = ax[0].plot(D50_sand_range_mum, RUTS_theo_freq2, 
         ls = '--', lw = 2, color = 'mediumorchid', label = 'Model 1 MHz')
m1, = ax[0].plot(TAAPS_freq1['D50_mum'],RUTS_samples_S2_D50_freq1, 
          'd', markersize = 8, ls = '', color = 'olive', markeredgecolor = 'black', markeredgewidth = 0.1, label = 'Calculated 400 kHz')
m2, = ax[0].plot(TAAPS_freq2['D50_mum'],RUTS_samples_S2_D50_freq2, 
          'p', markersize = 9, ls = '', color = 'mediumorchid', markeredgecolor = 'black', markeredgewidth = 0.1, label = 'Calculated 1 MHz')

ax[0].text(0.59, 0.05, '1 MHz Rayleigh -', fontsize = 12, rotation = 90, transform = ax[0].transAxes)
ax[0].text(0.65, 0.05, 'geometric regime limit', fontsize = 12, rotation = 90, transform = ax[0].transAxes)

ax[0].text(0.88, 0.05, '400 kHz Rayleigh -', fontsize = 12, rotation = 90, transform = ax[0].transAxes)
ax[0].text(0.94, 0.05, 'geometric regime limit', fontsize = 12, rotation = 90, transform = ax[0].transAxes)

ax[0].text(0.02, 0.95, '(a)', fontsize = 14, transform = ax[0].transAxes)

ax[0].tick_params(axis='both', which='major', labelsize = 14)
ax[0].set_xlim (63, 1500)
ax[0].set_ylim (-15, 15)
ax[0].set_xscale('log')
ax[0].set_ylabel(r'$\mathregular{RUTS}}$ (dB)', fontsize=16, weight = 'bold')
x_formatter = FixedFormatter(["100", "200", "500", "1000"])
x_locator = FixedLocator([100, 200, 500, 1000])
ax[0].xaxis.set_major_formatter(x_formatter)
ax[0].xaxis.set_major_locator(x_locator)
ax[0].legend(loc = 'lower left', fontsize = 12, framealpha = 1)

# handles = [(m1, m3, m5), (m2, m4, m6), (m3, m4), (m1, m2)]
# _, labels = ax[0].get_legend_handles_labels()
# fig.legend(handles = handles, labels=labels, 
#           handler_map = {tuple: mpl.legend_handler.HandlerTuple(None)},
#           loc="lower right", framealpha = 1,bbox_to_anchor=(0.26, 0.13), 
#           fontsize = 14)

ax[0].set_xlabel(r'$\mathregular{\overline{D_{50, sand}}}$ ($\mathregular{\mu}$m)', fontsize=16, weight = 'bold')
#ax[0].set_xlabel(r'Median sand grain size ($\mathregular{\mu}$m)', fontsize=16, weight = 'bold')

#2 
m3, = ax[1].plot(D50_sand_range_mum,RUTS_theo_freq1, 
         ls = '-', lw = 2, color = 'olive', label = '400 kHz')
m5 = ax[1].vlines(1/k_freq1/1e-6*2, -15,15, color = 'olive',ls = '--', lw = 2)

m1, = ax[1].plot(TAAPS_freq1['D50_mum'][0],RUTS_samples_S2_D50_freq1[0], 
          'd', markersize = 10, ls = '', color = 'olive', markeredgecolor = 'black', markeredgewidth = 0.1)
m1, = ax[1].plot(TAAPS_freq1['D50_mum'][11],RUTS_samples_S2_D50_freq1[11], 
          'd', markersize = 10, ls = '', color = 'olive', markeredgecolor = 'black', markeredgewidth = 0.1)

ax[1].text(0.88, 0.05, '400 kHz Rayleigh -', fontsize = 12, rotation = 90, transform = ax[1].transAxes)
ax[1].text(0.94, 0.05, 'geometric regime limit', fontsize = 12, rotation = 90, transform = ax[1].transAxes)

ax[1].text(0.02, 0.95, '(b)', fontsize = 14, transform = ax[1].transAxes)
ax[1].tick_params(axis='both', which='major', labelsize = 14)
ax[1].set_xlim (63, 1500)
ax[1].set_ylim (-15, 15)
ax[1].set_xscale('log')
x_formatter = FixedFormatter(["100", "200", "500", "1000"])
x_locator = FixedLocator([100, 200, 500, 1000])
...
# ax[1].set_xlabel(r'Median sand grain size ($\mathregular{\mu}$m)', fontsize=16, weight = 'bold')
ax[1].set_xlabel(r'$\mathregular{\overline{D_{50, sand}}}$ ($\mathregular{\mu}$m)', fontsize=16, weight = 'bold')
...
m5 = ax[0].vlines(1/k_freq1/1e-6*2, -15,15, color = 'olive',ls = '--', lw = 2)
m1, = ax[0].plot(TAAPS_freq1['D50_mum'],RUTS_samples_S2_D50_freq1, 
          'd', markersize = 11, ls = '', color = 'olive', markeredgecolor = 'black', markeredgewidth = 0.2, label = 'Calculated 400 kHz')

ax[0].vlines(200, -50,50, 'black', lw = 2, ls = ':')

ax[0].text(0.05, 0.95, '(a)', fontsize = 18, transform = ax[0].transAxes)
ax[0].text(0.88, 0.05, '400 kHz Rayleigh -', fontsize = 16, rotation = 90, transform = ax[0].transAxes)
ax[0].text(0.94, 0.05, 'geometric regime limit', fontsize = 16, rotation = 90, transform = ax[0].transAxes)
ax[0].text(0.38, 0.03, '$\overline{\mathregular{D_{50, sand, ref}}}$', fontsize = 16, rotation = 90, transform = ax[0].transAxes)

ax[0].tick_params(axis='both', which='major', labelsize = 20)
ax[0].set_xlim (63, 1500)
ax[0].set_ylim (-15, 15)
ax[0].set_xscale('log')
ax[0].set_ylabel(r'$\mathregular{RUTS}}$ (dB)', fontsize=20, weight = 'bold')
x_formatter = FixedFormatter(["100", "200", "500", "1000"])
x_locator = FixedLocator([100, 200, 500, 1000])
ax[0].xaxis.set_major_formatter(x_formatter)
ax[0].xaxis.set_major_locator(x_locator)
ax[0].axvspan(100, 350, 0,1500, color = 'lightgrey', alpha = 0.7, zorder = 0)
# ax[0].legend(loc = 'upper left', fontsize = 18, framealpha = 1)
# ax[0].set_xlabel(r'$\mathregular{\overline{D_{50, sand}}}$ ($\mathregular{\mu}$m)', fontsize=18, weight = 'bold')


# 1 MHz
m6 = ax[1].vlines(1/k_freq2/1e-6*2, -15,15, color = 'mediumorchid',ls = '--', lw = 2)
m4, = ax[1].plot(D50_sand_range_mum, RUTS_theo_freq2, 
          ls = '-', lw = 2, color = 'mediumorchid', label = 'Model 1 MHz')
m2, = ax[1].plot(TAAPS_freq2['D50_mum'],RUTS_samples_S2_D50_freq2, 
          'p', markersize = 11, ls = '', color = 'mediumorchid', markeredgecolor = 'black', markeredgewidth = 0.1, label = 'Calculated 1 MHz')
ax[1].vlines(200, -50,50, 'black', lw = 2, ls = ':')

ax[1].text(0.05, 0.95, '(b)', fontsize = 18, transform = ax[1].transAxes)
ax[1].text(0.59, 0.05, '1 MHz Rayleigh -', fontsize = 16, rotation = 90, transform = ax[1].transAxes)
ax[1].text(0.65, 0.05, 'geometric regime limit', fontsize = 16, rotation = 90, transform = ax[1].transAxes)
ax[1].text(0.38, 0.03, '$\overline{\mathregular{D_{50, sand, ref}}}$', fontsize = 16, rotation = 90, transform = ax[1].transAxes)

ax[1].tick_params(axis='both', which='major', labelsize = 20)
ax[1].set_xlim (63, 1500)
ax[1].set_ylim (-15, 15)
ax[1].set_xscale('log')
# ax[1].set_ylabel(r'$\mathregular{RUTS}}$ (dB)', fontsize=18, weight = 'bold')
x_formatter = FixedFormatter(["100", "200", "500", "1000"])
x_locator = FixedLocator([100, 200, 500, 1000])
ax[1].xaxis.set_major_formatter(x_formatter)
ax[1].xaxis.set_major_locator(x_locator)
m7 = ax[1].axvspan(100, 350, 0,1500, color = 'lightgrey', alpha = 0.7, zorder = 0, label = 'measured $\overline{\mathregular{D_{50, sand}}}$ range')
# ax[1].legend(loc = 'upper left', fontsize = 18, framealpha = 1)
fig.supxlabel(r'$\mathregular{\overline{D_{50, sand}}}$ ($\mathregular{\mu}$m)', fontsize=20, weight = 'bold')

handles = [m3, m4, m1, m2, m7]
#_, labels = ax.get_legend_handles_labels()
fig.legend(handles = handles, #labels=labels, 
          handler_map = {tuple: mpl.legend_handler.HandlerTuple(None)},
          fontsize = 18, loc = 'lower center', ncol = 3, bbox_to_anchor = (0.5, -0.17))
...
ax.text(0.05, 0.95, '(b)', fontsize = 16, transform = ax.transAxes)
...
ax[0].plot(x_range, 5*x_range,  zorder = 41,
         ls = (0, (1, 10)), lw = 1, color = 'black') 
ax[0].text(0.02, 0.95, '(d)', transform = ax[0].transAxes, fontsize = 12)
...
ax[1].text(0.02, 0.95, '(e)', transform = ax[1].transAxes, fontsize = 12)
...
ax[2].plot(x_range_d50, 5*x_range_d50,    
        ls = (0, (1, 10)), lw = 1, color = 'black')
ax[2].text(0.02, 0.95, '(f)', transform = ax[2].transAxes, fontsize = 12)
...
#%% Plot Fig 6 samples pump grain size
...
ax.set_ylabel('$\mathregular{\overline{D_{50, TW16-A}}\; (\mu m)}$', fontsize=18, weight = 'bold')
ax.tick_params(axis='both', which='major', labelsize = 16)
ax.set_xlim(63,800)
ax.set_ylim(63,800)
ax.set_xscale('log')
...
fig.tight_layout()
figname = 'Fig6_samples_pump_grain_size_TW16A'
fig.savefig(outpath_figures + '\\' + figname + '.png', dpi = 300, bbox_inches='tight')
...
methods = ['turbidity', 'fines_t_calc', 
           'TW16-A, fines', 'TW16-A', 'TW16-A, 400 kHz', 'TW16-A, 1 MHz',
            'rating_cr',]

# methods = ['turbidity', 'fines_t_calc', 
#            'TW16-A, fines', 'TW16, sand', 'TW16-A', 'TW16-A, 400 kHz', 'TW16-A, 1 MHz',
#             'rating_cr',]
...
# phi_TW16_cumsum_t = phi_TW16_cumsum/1000000000
Phi_power_cr_time_Q_t_cumsum = Phi_power_cr_time_Q_kg_s_cumsum/1000000000
Phi_sand_S2_D50_t_cumsum = Phi_sand_S2_D50_kg_s_cumsum/1000000000
# phi_TW16_B_cumsum_t = phi_TW16_B_cumsum/1000000000
Phi_sand_freq1_t_cumsum = Phi_sand_freq1_kg_s_cumsum/1000000000
Phi_sand_freq2_t_cumsum = Phi_sand_freq2_kg_s_cumsum/1000000000

#%% Plot Fig8
fig, ax = plt.subplots(2, 1, figsize = (12,12), dpi=300,gridspec_kw={'height_ratios': [1, 2]})
...
# spm
# ax[1].plot(Time_datetime_freq2[1:], Phi_fines_t_cumsum, 
#         ls = ':', lw = 2, color = 'midnightblue', label = '$\mathregular{{\Phi_{fines}}}$') #darkgoldenrod

# Rating curve
ax[1].plot(Time_Q_datetime[1:], Phi_power_cr_time_Q_t_cumsum, 
        lw = 2, color = 'lightseagreen', ls = '--', label = 'Rating curve')

# Acoustic      
# ax[1].plot(Time_datetime_TW16, phi_TW16_cumsum_t, 
#         ls = '-.', lw = 2, color = 'darkred', label = 'TW16')
ax[1].plot(Time_datetime_freq2[1:], Phi_sand_S2_D50_t_cumsum, 
        ls = '-', lw = 2, color = 'sienna', label = 'TW16-A')
# ax[1].plot(Time_datetime_TW16_B, phi_TW16_B_cumsum_t, 
#         ls = '-.', lw = 2, color = 'green', label = 'TW16-B')
ax[1].plot(Time_datetime_freq1[1:], Phi_sand_freq1_t_cumsum, 
        ls = '-', lw = 2, color = 'olive', label = 'TW16-A, 400 kHz')
ax[1].plot(Time_datetime_freq2[1:], Phi_sand_freq2_t_cumsum, 
        ls = '-', lw = 2, color = 'mediumorchid', label = 'TW16-A, 1 MHz')
 

ax[1].hlines(3, Time_datetime_freq2[spring_dates['Start_int_freq2']][0], Time_datetime_freq2[spring_dates['End_int_freq2']][0],
            colors = 'yellowgreen', lw = 15, zorder = 40)#, label = 'Snowmelt period')
ax[1].hlines(3, Time_datetime_freq2[spring_dates['Start_int_freq2']][1], Time_datetime_freq2[spring_dates['End_int_freq2']][1],
            colors = 'yellowgreen', lw = 15, zorder = 40)
ax[1].hlines(3, Time_datetime_freq2[spring_dates['Start_int_freq2']][2], Time_datetime_freq2[spring_dates['End_int_freq2']][2],
            colors = 'yellowgreen', lw = 15, zorder = 40)
ax[1].arrow(Time_datetime_freq2[events_dates['Start_int_freq2'][0]], 2.4, 0, -0.3, 
          head_width = 12, head_length = 0.1, width = 3, ec ='None', fc = 'royalblue', zorder = 40) #, label = 'Floods')
ax[1].arrow(Time_datetime_freq2[events_dates['Start_int_freq2'][1]], 2.8, 0, -0.3, 
          head_width = 12, head_length = 0.1, width = 3, ec ='None', fc = 'royalblue', zorder = 40)
ax[1].arrow(Time_datetime_freq2[events_dates['Start_int_freq2'][2]], 0.7, 0, -0.3, 
          head_width = 12, head_length = 0.1, width = 3, ec ='None', fc = 'darkviolet', zorder = 40)

ax[1].set_xlabel('Time', fontsize=16, weight = 'bold')
ax[1].set_ylabel('Cumulative sand mass (Mt)', fontsize=16, weight = 'bold')
ax[1].tick_params(axis='both', which='major', labelsize = 14)
...
ax[1].text(0.31, 0.71, 'Flood', fontsize = 14, rotation = 90, transform = ax[1].transAxes)
ax[1].text(0.75, 0.85, 'Flood', fontsize = 14, rotation = 90, transform = ax[1].transAxes)
...
ax[1].plot(Time_datetime_freq2[1:], Phi_sand_S2_D50_kg_s_cumsum, 
        ls = '-', lw = 3, color = 'sienna', label = 'TW16-A')
...
ax[1].hlines(2.3*1e9, Time_datetime_freq2[spring_dates['Start_int_freq2']][0], Time_datetime_freq2[spring_dates['End_int_freq2']][0],
            colors = 'yellowgreen', lw = 15, zorder = 40)#, label = 'Snowmelt period')
ax[1].hlines(2.3*1e9, Time_datetime_freq2[spring_dates['Start_int_freq2']][1], Time_datetime_freq2[spring_dates['End_int_freq2']][1],
            colors = 'yellowgreen', lw = 15, zorder = 40)
ax[1].hlines(2.3*1e9, Time_datetime_freq2[spring_dates['Start_int_freq2']][2], Time_datetime_freq2[spring_dates['End_int_freq2']][2],
            colors = 'yellowgreen', lw = 15, zorder = 40)
...
ax[1].xaxis.set_major_formatter(md.DateFormatter('%d/%m/%Y'))
ax[1].set_xlim(Time_datetime_freq2[0], Time_datetime_freq2[-1])
ax[1].set_ylim(0,2.3*1e9)
ax2.set_ylim(0,2.3*1e9)
...
fig.tight_layout()
figname = 'Fig8_TW16A_dual_single'
fig.savefig(outpath_figures + '\\' + figname + '.png', dpi = 300, bbox_inches='tight')
# fig.savefig(outpath_figures+ '\\' + figname +  '.eps', dpi = 300, bbox_inches='tight') 
# fig.savefig(outpath_figures+ '\\' + figname +  '.pdf', dpi = 300, bbox_inches='tight')
...
ax[1].plot(Time_datetime_freq2[1:], Phi_sand_S2_D50_kg_s_cumsum, 
        ls = '-', lw = 3, color = 'sienna', label = 'TW16-A')
# ax[1].plot(Time_datetime_TW20_B, phi_TW20_B_cumsum, 
#         ls = '-.', lw = 2, color = 'green', label = 'TW20-B')
# ax[1].plot(Time_datetime_freq1[1:], Phi_sand_freq1_kg_s_cumsum, 
#         ls = '-', lw = 2, color = 'brown', label = 'TW20-A, 400 kHz')
# ax[1].plot(Time_datetime_freq2[1:], Phi_sand_freq2_kg_s_cumsum, 
#         ls = '-', lw = 2, color = 'palevioletred', label = 'TW20-A, 1 MHz')
 
ax[1].hlines(2.2*1e9, Time_datetime_freq2[spring_dates['Start_int_freq2']][0], Time_datetime_freq2[spring_dates['End_int_freq2']][0],
            colors = 'yellowgreen', lw = 15, zorder = 40)#, label = 'Snowmelt period')
ax[1].hlines(2.2*1e9, Time_datetime_freq2[spring_dates['Start_int_freq2']][1], Time_datetime_freq2[spring_dates['End_int_freq2']][1],
            colors = 'yellowgreen', lw = 15, zorder = 40)
ax[1].hlines(2.2*1e9, Time_datetime_freq2[spring_dates['Start_int_freq2']][2], Time_datetime_freq2[spring_dates['End_int_freq2']][2],
            colors = 'yellowgreen', lw = 15, zorder = 40)
ax[1].arrow(Time_datetime_freq2[events_dates['Start_int_freq2'][0]], 1.8*1e9, 0, -0.3*1e9, 
          head_width = 12, head_length = 0.1*1e9, width = 3, ec ='None', fc = 'royalblue', zorder = 40) #, label = 'Floods')
ax[1].arrow(Time_datetime_freq2[events_dates['Start_int_freq2'][1]], 2.1*1e9, 0, -0.3*1e9, 
...
ax[1].text(0.2, 0.6, 'TW16-A', fontsize = 20, transform = ax[1].transAxes)
ax[1].text(0.15, 0.31, 'Rating curve', fontsize = 20, transform = ax[1].transAxes)

ax[1].set_xlabel('Time', fontsize=20, weight = 'bold')
ax[1].set_ylabel('Cumulative sand mass (kg)', fontsize=20, weight = 'bold')
ax[1].tick_params(axis='both', which='major', labelsize = 18)
...
ax[1].xaxis.set_major_formatter(md.DateFormatter('%d/%m/%Y'))
ax[1].set_xlim(Time_datetime_freq2[0], Time_datetime_freq2[-1])
ax[1].set_ylim(0,2.2*1e9)
ax2.set_ylim(0,2.2*1e9)
# ax[1].legend(fontsize = 20, loc = 'lower right', ncol = 3)#, bbox_to_anchor = (0.5, -0.23))
...
ax.plot(Time_datetime_freq2, D50_est_S2_D50, '.', markersize = 3,  
        color = 'peru', label = 'fines')
ax.plot(TAAPS_freq2['Date'], TAAPS_freq2['D50_mum'], 'D', 
        color = 'black', label = 'sand')

ax.set_xlabel('\mathregular{\overline{D_{50}} \; (\mu m)}$Time', fontsize=16, weight = 'bold')
...
p4, = ax[0].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
               ...
               lw = 2, ls = '-', 
          color = 'darkorange', label = r'$\mathregular{\overline{C_{\rm{fines, TW16-A}}}}$', zorder = 10)
...
p1, = ax[1].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              ...
              ls = '-', lw = 2, 
        color = 'peru', label = r'$\mathregular{\overline{C_{\rm{sand, TW16-A}}}}$', zorder = 10)
p12, = ax[1].plot(Time_datetime_freq1[events_dates['Start_int_freq1'][i]:events_dates['End_int_freq1'][i]], 
              ...
              ls = '-', lw = 2, 
        color = 'navy', label = r'$\mathregular{\overline{C_{\rm{sand, TW16-A, 400 kHz}}}}$', zorder = 10)
p13, = ax[1].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              ...
              ls = '-', lw = 2, 
        color = 'darkred', label = r'$\mathregular{\overline{C_{\rm{sand,TW16-A, 1 MHz}}}}$', zorder = 10)      
...
p8, = ax[3].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]],
        ...
        color = 'darkviolet', lw = 2, ls = '-', label = r'$\mathregular{\overline{D_{50,sand, TW16-A}}}$')
...
p8, = ax[3].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]],
               D50_est_S2_D50[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]],
        color = 'darkviolet', ls = '-', lw = 2, label = r'$\mathregular{\overline{D_{50,sand, TW16-A}}}$')    
...
p1, = ax[1].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              C_sand_S2_D50_g_l[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              ls = '-', lw = 3, 
        color = 'sienna', label = r'TW16-A', zorder = 20)  

p12, = ax[1].plot(Time_datetime_freq1[events_dates['Start_int_freq1'][i]:events_dates['End_int_freq1'][i]], 
              C_sand_S2_D50_freq1_g_l[events_dates['Start_int_freq1'][i]:events_dates['End_int_freq1'][i]], 
              ls = '-', lw = 3, 
        color = 'olive', label = r'TW16-A, 400 kHz', zorder = 10)
p13, = ax[1].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              C_sand_S2_D50_freq2_g_l[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              ls = '-', lw = 3, 
        color = 'mediumorchid', label = r'TW16-A, 1 MHz', zorder = 10) 
...
#%% Plot Fig9_C Events timeseries i = 2 Spring flood May 2021
i = 2
fig, ax = plt.subplots(3, 1, figsize = (14,10), dpi=300)
...
for j in range(len(TAAPS_freq2)):
    ax[0].hlines(TAAPS_freq2['Fine_concentration_g_l'][j], samples_start_datetime[j], samples_end_datetime[j], 
          lw = 4, color = 'crimson', zorder = 40)    
p5 = ax[0].hlines(TAAPS_freq2['Fine_concentration_g_l'][0], samples_start_datetime[0], samples_end_datetime[0], 
       lw = 4, color = 'crimson', label = r'Sampler', zorder = 40)
p6, = ax[0].plot(Time_ISCO_mid_datetime, ISCO_data['Fine_concentration_g_l'], marker = 'o',              
        ls = '', markersize = 8, color = 'forestgreen', markeredgecolor = 'black', markeredgewidth = 0.2, zorder = 40,
        label = r'ISCO')

p4, = ax[0].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
               C_fines_est_time_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]],
               ls = '-', lw = 2, 
         color = 'darkgoldenrod', label = r'TW16-A', zorder = 10)
...
ax[0].tick_params(axis='both', which='major', labelsize = 14)
ax[0].xaxis.set_ticklabels([])
ax[0].legend(fontsize = 14, loc = 'upper right', framealpha = 1, bbox_to_anchor = (1.28, 0.98))  
...
# CSands
p2 =  ax[1].hlines(TAAPS_freq2['Sand_concentration_g_l'][0], samples_start_datetime[0], samples_end_datetime[0], 
       lw = 4, color = 'darkorange', label = r'Sampler', zorder = 40)
for j in range(len(TAAPS_freq2)):
    ax[1].hlines(TAAPS_freq2['Sand_concentration_g_l'][j], samples_start_datetime[j], samples_end_datetime[j], 
          lw = 4, color = 'darkorange', zorder = 40)
p3, =  ax[1].plot(Time_ISCO_mid_datetime, ISCO_data['ISCO_sand_concentration_corr_g_l'], marker = 'o',              
        ls = '', markersize = 9, color = 'yellowgreen', markeredgecolor = 'black', markeredgewidth = 0.2, zorder = 40,
        label = r'ISCO')

p1, = ax[1].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              C_sand_S2_D50_g_l[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              ls = '-', lw = 2, 
        color = 'mediumslateblue', label = r'TW16-A', zorder = 10)
p12, = ax[1].plot(Time_datetime_freq1[events_dates['Start_int_freq1'][i]:events_dates['End_int_freq1'][i]], 
              C_sand_S2_D50_freq1_g_l[events_dates['Start_int_freq1'][i]:events_dates['End_int_freq1'][i]], 
              ls = '-', lw = 2, 
        color = 'brown', label = r'TW16-A, 400 kHz', zorder = 10)
p13, = ax[1].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              C_sand_S2_D50_freq2_g_l[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]], 
              ls = '-', lw = 2, 
        color = 'palevioletred', label = r'TW16-A, 1 MHz', zorder = 10)  
   
p16, = ax[1].plot(Time_Q_datetime, Csand_power_cr_time_Q, 
              ls = '--', lw = 2, color = 'lightseagreen', label = r'Rating curve', zorder = 10)
...
ax[1].set_xlim(Time_datetime_freq2[events_dates['Start_int_freq2'][i]], Time_datetime_freq2[events_dates['End_int_freq2'][i]])
ax[1].tick_params(axis='both', which='major', labelsize = 14)
ax[1].legend(fontsize = 14, loc = 'upper right', framealpha = 1, facecolor = 'white', bbox_to_anchor = (1.3, 0.98))  

# D50,sands
p8, = ax[2].plot(Time_datetime_freq2[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]],
               D50_est_S2_D50[events_dates['Start_int_freq2'][i]:events_dates['End_int_freq2'][i]],
        color = 'olivedrab', lw = 2, ls = '-',  label = r'TW16-A')
p9 = ax[2].hlines(TAAPS_freq2['D50_mum'][0], samples_start_datetime[0], samples_end_datetime[0], 
        lw = 4, color = 'maroon', zorder = 30, label = r'Sampler')
for j in range(len(TAAPS_freq2)):
    ax[2].hlines(TAAPS_freq2['D50_mum'][j], samples_start_datetime[j], samples_end_datetime[j], 
          lw = 4, color = 'maroon', zorder = 30)
...
ax[2].set_xlim(Time_datetime_freq2[events_dates['Start_int_freq2'][i]], Time_datetime_freq2[events_dates['End_int_freq2'][i]])
ax[2].tick_params(axis='both', which='major', labelsize = 14)
ax[2].set_ylabel('$\mathregular{\overline{D_{50, sand}}}$ ($\mathregular{\mu}$m)', fontsize=16, weight = 'bold') 
ax[2].set_xlabel('Time', fontsize=16, weight = 'bold')   
ax[2].legend(fontsize = 14, loc = 'upper right', bbox_to_anchor = (1.24, 0.98))  

ax[0].text(0.02, 0.9, '(a)', fontsize = 14, transform = ax[0].transAxes)
ax[1].text(0.02, 0.9, '(b)', fontsize = 14, transform = ax[1].transAxes)
ax[2].text(0.02, 0.9, '(c)', fontsize = 14, transform = ax[2].transAxes)
ax[0].text(0.07, 0.9, 'Fine sediment concentration', fontsize = 14, transform = ax[0].transAxes)
ax[1].text(0.07, 0.9, 'Sand concentration', fontsize = 14, transform = ax[1].transAxes)
ax[2].text(0.07, 0.9, 'Sand grain size', fontsize = 14, transform = ax[2].transAxes)

# handles = [p5, p6, p7, p18, p19, p4, p10, p2, p3, p1, p12, p13, p16, p9, p8]
# #_, labels = ax.get_legend_handles_labels()
# fig.legend(handles = handles, #labels=labels, 
#           handler_map = {tuple: mpl.legend_handler.HandlerTuple(None)},
#           fontsize = 16, loc = 'lower center', ncol = 5, bbox_to_anchor = (0.5, -0.15))
...
ax.plot(Q_time_freq2, s_time_freq2, lw = 0, marker = '.', markersize = 1, 
        color = 'darkgoldenrod')

ax.set_xlabel('Discharge (m³/s)', fontsize=16, weight = 'bold')
...
ax.plot(C_sand_S2_D50_g_l[10], D50_est_S2_D50[10],
        marker = '.', markersize = 20, color = 'burlywood', markeredgewidth = 0, lw = 0, zorder = 0, label = 'TW16-A')
...
#%% Csandfre1 - Csandfreq2

fig, ax = plt.subplots(1, 1, figsize=(8,6), dpi=100)

cax = ax.scatter(C_sand_S2_D50_freq1_samples_g_l, C_sand_S2_D50_freq2_samples_g_l,
           c = TAAPS_freq1['D50_mum'],cmap = cmap,norm=norm,
        marker = 'D', s = 50, ec = 'black', lw = 0.5,label = 'Sampler')

ax.plot(C_sand_S2_D50_freq1_time_freq2_g_l, C_sand_S2_D50_freq2_g_l,
        marker = '.', markersize = 3, color = 'grey', markeredgewidth = 0, lw = 0, zorder = 0)
ax.plot(np.arange(0.001,10),np.arange(0.001,10), lw = 1, ls = '--', color = 'black' )
# ax.plot(C_sand_S2_D50_g_l[10], D50_est_S2_D50[10],
#         marker = '.', markersize = 20, color = 'burlywood', markeredgewidth = 0, lw = 0, zorder = 0, label = 'TW16-A')
...
cbar.ax.set_yticklabels(['75','100','125','150','175','200','225','250','275','300', '325', '350'],ha='right')
cbar.ax.yaxis.set_tick_params(pad=35) 
cbar.set_label(r'$\mathregular{\overline{D_{50}} \; (\mu m)}$', weight = 'bold', labelpad= 10, fontsize = 14)

ax.text(0.15,0.75,'$\mathregular{\overline{D_{50,sand}}}$ > $\mathregular{\overline{D_{50,sand, ref}}}$',
        fontsize = 14, transform = ax.transAxes)
ax.text(0.05,0.15,'$\mathregular{\overline{D_{50,sand}}}$ = $\mathregular{\overline{D_{50,sand, ref}}}$',
        fontsize = 14, transform = ax.transAxes, backgroundcolor = 'white')
ax.text(0.55,0.1,'$\mathregular{\overline{D_{50,sand}}}$ < $\mathregular{\overline{D_{50,sand, ref}}}$', 
        fontsize = 14, transform = ax.transAxes)
ax.set_xlabel('$\mathregular{\overline{C_{sand, 400kHz}}}$ (g/l)', fontsize=16, weight = 'bold')
ax.set_ylabel('$\mathregular{\overline{C_{sand, 1 MHz}}}$ (g/l)', fontsize=16, weight = 'bold')
ax.tick_params(axis='both', which='major', labelsize = 14)
ax.set_xlim(0.001,5)
ax.set_ylim(0.001,5)
ax.set_xscale('log')
